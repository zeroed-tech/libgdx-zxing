...
public class QRGenerator {
    ...
    public QRGenerator(){
        this(5, 1, Color.BLACK, Color.WHITE);
    }

    public QRGenerator(int blockSize){
        this(blockSize, 1, Color.BLACK, Color.WHITE);
    }

    public QRGenerator(int blockSize, int borderSize){
        this(blockSize, borderSize, Color.BLACK, Color.WHITE);
    }

    public QRGenerator(int blockSize, int borderSize, Color primary, Color secondary){
